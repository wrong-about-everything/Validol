.. Validol documentation master file, created by
   sphinx-quickstart on Sun Oct 13 20:15:29 2019.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to Validol's documentation!
===================================
...
------------------------------------
You just add another validating object in the validating object composition.
