...
final public class SingleSuccessful implements Validatable
{
    private String fieldName;
    private Error error;
    private Validatable<?>[] validatables;

    public SingleSuccessful(String fieldName, Error error, Validatable<?> ... validatables) throws Exception
    {
        if (fieldName == null) {
