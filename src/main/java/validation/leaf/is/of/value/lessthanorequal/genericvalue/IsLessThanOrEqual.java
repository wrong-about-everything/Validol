...
final public class IsLessThanOrEqual<T extends Comparable<T>> implements Validatable<T>
{
    ...
    public IsLessThanOrEqual(Validatable<T> original, T value, Error error) throws Exception
    {
        if (original == null) {
    ...
    public IsLessThanOrEqual(Validatable<T> original, T value) throws Exception
    {
        this(original, value, new MustBeLessThanOrEqual<>(value));
    }
